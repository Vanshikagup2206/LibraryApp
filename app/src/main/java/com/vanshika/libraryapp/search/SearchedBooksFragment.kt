...
import com.vanshika.libraryapp.databinding.FragmentSearchedBooksBinding
 ...
 * Use the [SearchedBooksFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SearchedBooksFragment : Fragment(), BooksClickInterface{
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    var binding : FragmentSearchedBooksBinding ?= null
    ...
    override fun onCreateView(
        ...
        binding = FragmentSearchedBooksBinding.inflate(layoutInflater)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchBookAdapter = SearchBookAdapter(booksSpecificationList, this)
        linearLayoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)

        binding?.rvBooksSpecification?.layoutManager = linearLayoutManager
        binding?.rvBooksSpecification?.adapter = searchBookAdapter
        getSearchedBook()
    ...
    companion object {
         ...
         * @return A new instance of fragment SearchedBooksFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SearchedBooksFragment().apply {
